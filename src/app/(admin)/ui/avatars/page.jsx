...
const RoundedCircle = ({
  ...
  return <>
			<Col md={4}>
				<Image src={avatar3} alt="" className={`rounded-circle avatar-${size}`} />
				<p>
				...
				<Col xxl={12}>
					<Card>
						...
						<CardBody>
							<Row>
								<Col md={3}>
									<Image src={avatar2} alt="avatar" className="avatar-xs rounded" />
									<p>
										<code>.avatar-xs</code>
									</p>
									<Image src={avatar3} alt="avatar" className="avatar-sm rounded mt-2" />{' '}
									<p className="mb-2 mb-sm-0">
										<code>.avatar-sm</code>
									</p>
								</Col>
								<Col md={3}>
									<Image src={avatar4} alt="avatar" className="avatar-md rounded" />
									<p>
										<code>.avatar-md</code>
									</p>
								</Col>
				...
				<Col xs={12}>
					<Card>
						...
						<CardBody>
							<Row>
								<Col sm={2}>
									<Image src={img1} alt="avatar" className="rounded" width="200" />
									<p className="mb-0">
										<code>.rounded</code>
									</p>
								</Col>
								<Col sm={2} className="text-center">
									<Image src={avatar6} alt="avatar" className="rounded" width="120" />
									<p className="mb-0">
										<code>.rounded</code>
									</p>
								</Col>
								<Col sm={2} className="text-center">
									<Image src={avatar7} alt="avatar" className="rounded-circle" width="120" />
									<p className="mb-0">
										<code>.rounded-circle</code>
									</p>
								</Col>
								<Col sm={2}>
									<Image src={img2} alt="avatar" className="img-thumbnail" width="200" />
									<p className="mb-0">
										<code>.img-thumbnail</code>
									</p>
								</Col>
								<Col sm={2}>
									<Image src={avatar8} alt="avatar" className="rounded-circle img-thumbnail" width="120" />
									<p className="mb-0">
					...
					<Card>
						<CardHeader>
							...
							<p className="text-muted  mb-0">
								...
								<code>data-bs-toggle=&qout;tooltip&qout;</code> to show avatar group
								images with tooltip.
							</p>
						</CardHeader>
						<CardBody>
							<Row>
								...
								<Col lg={6}>
									<div className="mt-lg-0 mt-3">
										<div className="avatar-group">
											<Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Tosha">
												<Image src={avatar1} alt="" className="rounded-circle avatar-sm" />
											</Link>
											<Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Brain">
												<Image src={avatar3} alt="" className="rounded-circle avatar-sm" />
											</Link>
											<Link href="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Hooker">
