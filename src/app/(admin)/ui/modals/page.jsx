...
import { Button, Card, CardBody, CardHeader, Col, Modal, ModalBody, ModalFooter, ModalHeader, ModalTitle, Row } from 'react-bootstrap';
			...
			<Card>
				...
				<CardBody>
					...
					<Modal show={show} fullscreen={fullscreen ?? true} onHide={() => setShow(false)}>
						...
						<ModalBody>...</ModalBody>
						<ModalFooter>
							<Link href="#" className="btn btn-light waves-effect" onClick={() => setShow(false)}>
								Close
							</Link>
