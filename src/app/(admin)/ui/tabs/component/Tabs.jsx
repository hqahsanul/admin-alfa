...
import { Card, CardBody, CardHeader, Col, Nav, Row, Tab } from 'react-bootstrap';
const Tabs = () => {
  const tabContents = [{
    id: '1',
    title: 'Home',
  ...
  return <>
			...
			<Row>
				<Col xl={6}>
                  ...
                  return <Nav.Item as="li" role="presentation" key={idx}>
												<Nav.Link as={Link} href="#" eventKey={tab.title}>
								...
								<Tab.Content>
									{(tabContents || []).map((tab, idx) => {
                  return <Tab.Pane eventKey={tab.title} id={tab.id} key={idx}>
												<Row>
													<Col sm="12">
														<p>{tab.text}</p>
