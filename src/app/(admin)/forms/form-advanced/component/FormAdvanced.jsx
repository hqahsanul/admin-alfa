...
const MaskedInput = dynamic(() => import('react-text-mask-legacy'), {
  ssr: false
});
          ...
          <Col md={6}>
            <form action="#">
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">e.g &qout;DD/MM/YYYY&qout;</span>
              </div>
              <div className="mb-3">
                <label className="form-label">Hour</label>
                <MaskedInput mask={[/\d/, /\d/, ':', /\d/, /\d/, ':', /\d/, /\d/]} placeholder="Enter time" className="form-control" />
                <span className="fs-13 text-muted">e.g &qout;HH:MM:SS&qout;</span>
              </div>
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">
                  e.g &qout;DD/MM/YYYY HH:MM:SS&qout;
                </span>
              </div>
              <div className="mb-3">
                <label className="form-label">ZIP Code</label>
                <MaskedInput mask={[/\d/, /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/]} placeholder="Enter zip code" className="form-control" />
                <span className="fs-13 text-muted">e.g &qout;xxxxx-xxx&qout;</span>
              </div>
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">e.g &qout;x-xx-xx-xx&qout;</span>
              </div>
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">e.g &qout;Your money&qout;</span>
              </div>
              <div>
                ...
                <span className="fs-13 text-muted">e.g &qout;#.##0,00&qout;</span>
              </div>
            </form>
          </Col>
          <Col md={6}>
            <form action="#">
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">e.g &qout;xxxx-xxxx&qout;</span>
              </div>
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">e.g &qout;(xx) xxxx-xxxx&qout;</span>
              </div>
              <div className="mb-3">
                ...
                <span className="fs-13 text-muted">e.g &qout;(xxx) xxx-xxxx&qout;</span>
              </div>
              <div className="mb-3">
...
const FormMaxLength = () => {
  ...
  return <Card>
      <CardHeader>
        ...
        <p className="text-muted mb-0">
          Uses the HTML5 attribute &qout;maxlength&qout; to work. Just specify{' '}
          <code>data-toggle=&qout;maxlength&qout;</code> attribute to have maxlength
        ...
        <Row>
          ...
          <Col lg={6} className="mt-3 mt-lg-0">
            <Form.Group className="position-relative">
              ...
              <Form.Control isInvalid={isInvalid2} as="textarea" data-toggle="maxlength" maxLength={225} rows={3} placeholder="This textarea has a limit of 225 chars." onChange={e => changeHandler(e, 'textarea')}></Form.Control>
              <Form.Control.Feedback type="invalid" tooltip>
