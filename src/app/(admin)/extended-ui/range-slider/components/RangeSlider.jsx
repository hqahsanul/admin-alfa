...
const RangeSlider = () => {
  ...
  return <>
			...
			<Row>
              ...
              min: 0,
              max: 100
            }} start={[20]} connect onSlide={(render, handle, value, un, percent) => onSlide(1, value, percent)} />
              ...
              min: 0,
              max: 100
            }} start={[20]} step={10} connect onSlide={(render, handle, value, un, percent) => onSlide(2, value, percent)} />
							<p className="mt-2 mb-0">
								Value:{' '}
								{selectedVals ? <span>
              ...
              min: 10,
              max: 150
            }} start={[20, 45]} connect onSlide={value => onSlide2(1, value)} />
							<p className="mt-2 mb-0">
								Value:{' '}
              ...
              min: 10,
              max: 150
            }} start={[20, 45]} step={15} connect onSlide={value => onSlide2(2, value)} />
							<p className="mt-2 mb-0">
								Value:{' '}
