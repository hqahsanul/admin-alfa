            ...
            <CardBody>
              ...
              <div className="d-print-none mt-4">
                <div className="text-center">
                  <Button variant="primary" href="" className="btn btn-"><i className="ri-printer-line" /> Print</Button>&nbsp;
                  <Button variant="info" href="" className="btn btn-">Submit</Button>
                </div>
              </div>
            </CardBody>
          </Card>
