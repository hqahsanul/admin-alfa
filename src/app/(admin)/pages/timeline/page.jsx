                ...
                return <React.Fragment key={idx}>
                    ...
                    return idx % 2 === 0 ? <article className="timeline-item alt" key={idx}>
														<div className="timeline-desk">
															<div className="panel">
																<div className="timeline-box">
																	...
																	<span className={`timeline-icon ${item.variant ? `bg-${item.variant}` : ''}`}>
																		<i className="ri-record-circle-line"></i>
																	</span>
																	<h4 className={`fs-16 fw-semibold ${item.variant ? `text-${item.variant}` : ''}`}>
																		{item.date}
																	</h4>
                                  ...
                                  return <Link href="#" key={idx}>
													...
													</article> : <article key={idx} className="timeline-item">
														<div className="timeline-desk">
															<div className="panel">
																<div className="timeline-box">
					...
					<Card>
						<div className="card-body">
							<div className="timeline timeline-left">
								{Object.keys(timelineData).slice(0, 1).map((day, idx) => {
                return <React.Fragment key={idx}>
												<article className="timeline-item alt">
												...
												{(timelineData[day] || []).map((item, idx) => {
                    return <article key={idx} className="timeline-item">
															<div className="timeline-desk">
																<div className="panel">
																	<div className="timeline-box">
																		<span className="arrow"></span>
