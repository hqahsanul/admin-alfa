			...
			<Card.Body>
				<div className="d-flex align-items-center">
					...
					<div className="flex-shrink-0" dir="ltr">
						<ReactApexChart height={67} width={80} options={usChartOpts} series={usChartOpts.series} type="pie" className="apex-charts" />
					</div>
				</div>
			</Card.Body>
		</Card>;
...
const YearlySelesChart = () => {
  ...
  return <>
			<CustomCardPortlet cardTitle="Yearly Sales Report" titleClass="header-title">
				<div dir="ltr">
					<ReactApexChart height={250} options={yearlyChartOpts} series={yearlyChartOpts.series} type="line" className="apex-charts" />
				</div>
