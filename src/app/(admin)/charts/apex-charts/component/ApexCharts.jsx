...
const ScatterBoxplotChart = () => {
  const ScatterBoxplotOps = {
    series: [{
      name: 'Box',
      type: 'boxPlot',
      data: [{
...
const MonochromePolarArea = () => {
  const MonochromePolarAreaOpt = {
...
const RadarWithPolygon = () => {
  const PolygonFillOpt = {
    chart: {
      height: 350,
      type: 'radar'
    },
...
const CandlestickChart = () => {
  ...
  const simpleCandlestickChartOpts = {
    chart: {
      height: 400,
      type: 'candlestick'
    },
