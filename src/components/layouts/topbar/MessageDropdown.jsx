...
const MessageDropdown = ({
  ...
  return <>
			<Dropdown show={dropDownOpen} onToggle={toggleDropDown}>
				<Dropdown.Toggle as="a" className="nav-link dropdown-toggle arrow-none" role="button" onClick={toggleDropDown}>
				...
				<Dropdown.Menu align="end" className="dropdown-menu-animated dropdown-lg py-0">
					<div className="p-2 border-top-0 border-start-0 border-end-0 border-dashed border" onClick={toggleDropDown}>
          ...
          maxHeight: 300
            ...
            return <Link key={idx} href="" className="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
									<Card.Body>
