...
const RightSidebar = () => {
  ...
  return <Offcanvas show={isOpenRightSideBar} onHide={handleRightSideBar} placement="end" id="theme-settings-offcanvas">
			...
			<div className="offcanvas-footer border-top p-3 text-center">
				<Row>
					<Col xs={6}>
						<Button type="button" variant="light" className="w-100" id="reset-layout" onClick={reset}>
							Reset
						</Button>
					</Col>
					<div className="col-6">
						<Link href="https://themes.getbootstrap.com/product/hyper-responsive-admin-dashboard-template/" target="_blank" role="button" className="btn btn-primary w-100">
							Buy Now
						</Link>
					</div>
				</Row>
