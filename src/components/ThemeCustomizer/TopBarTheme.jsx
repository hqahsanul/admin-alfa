			...
			<Row>
				<Col xs={4}>
					<Form.Check className="form-switch card-switch mb-1">
						<Form.Check.Input className="form-check-input" type="radio" name="data-topbar-color" id="topbar-color-light" value={layoutConstants.light} onChange={e => handleChangeTopBarTheme(e.target.value)} checked={topBarTheme === layoutConstants.light} />
				...
				<Col xs={4}>
					<Form.Check className="form-switch card-switch mb-1">
						<Form.Check.Input className="form-check-input" type="radio" name="data-topbar-color" id="topbar-color-dark" value={layoutConstants.dark} onChange={e => handleChangeTopBarTheme(e.target.value)} checked={topBarTheme === layoutConstants.dark} />
						<Form.Check.Label className="form-check-label" htmlFor="topbar-color-dark">
							<Image className='img-fluid' src={topBarDark} alt="" />
						</Form.Check.Label>
					</Form.Check>
