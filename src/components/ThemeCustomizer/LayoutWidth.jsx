			...
			<Row>
				<Col xs={4}>
					<Form.Check className="form-check form-switch card-switch mb-1">
						<Form.Check.Input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-fluid" value={layoutConstants.fluid} onChange={e => handleChangeLayoutWidth(e.target.value)} />
				...
				<Col xs={4}>
					<div id="layout-boxed">
						<Form.Check className="form-switch card-switch mb-1">
							<Form.Check.Input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-boxed" value={layoutConstants.boxed} onChange={e => handleChangeLayoutWidth(e.target.value)} checked={layoutWidth === layoutConstants.boxed} />
							<label className="form-check-label" htmlFor="layout-mode-boxed">
								<Image src={layoutBox} alt="" className="img-fluid" />
							</label>
						</Form.Check>
